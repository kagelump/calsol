...
//void playMusic(String song) {
  //choose song
  //if (song == "tetris") {
  //  int duration[] = tetrisDuration;
  //  int notes[] = tetrisNotes;
  //}
  //else if (song == "badromance") {
  //  int duration[] = badRomanceDuration;
  //  int notes[] = badRomanceNotes;
  //}
  //else {
  //  return;
  //}
  ...
  //  int noteDuration = 1000/tetrisDuration[thisNote];
  //  tone(BUZZER, tetrisNotes[thisNote], noteDuration);
